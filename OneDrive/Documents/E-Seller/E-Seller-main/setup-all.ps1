# E-Seller - Touts installer en UN script
Write-Host "🤖 Installation..." -ForegroundColor Cyan

# 1. Creer le dossier
New-Item -ItemType Directory -Path "src\app\ai-test" -Force -ErrorAction SilentlyContinue
...
Set-Content -Path "src\app\ai-test\page.tsx" -Value $content -Encoding UTF8
Write-Host "✅ Page creee!" -ForegroundColor Green
