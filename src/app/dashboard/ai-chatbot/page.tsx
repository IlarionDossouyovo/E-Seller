  ...
  return (
    <div className="space-y-6">
      ...
      <div className="mt-8 flex justify-between items-center">
        <Link href="/dashboard/assistant" className="flex items-center gap-2 px-4 py-2 bg-slate-800 hover:bg-slate-700 rounded-lg text-slate-300 transition-colors">
          <ArrowLeft className="w-4 h-4" />
          Assistant
        </Link>
        <Link href="/dashboard/ai-assistant" className="flex items-center gap-2 px-4 py-2 bg-slate-800 hover:bg-slate-700 rounded-lg text-slate-300 transition-colors">
          AI Assistant
