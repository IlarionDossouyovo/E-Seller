...
const navItems = [
  ...
  { name: 'Customer Reviews', href: '/dashboard/customer-reviews', icon: StarIcon },
  ...
  { name: 'AI Command Center', href: '/dashboard/founder/ai-command-center', icon: Crown },
  ...
  { name: 'Bundle Builder', href: '/dashboard/bundle-builder', icon: Package },
  { name: 'BOGO', href: '/dashboard/bogo-deals', icon: Gift },
  { name: 'Tiered', href: '/dashboard/tiered-pricing', icon: TrendingDown },
  { name: 'Shipping Labels', href: '/dashboard/shipping-labels', icon: Zap },
  ...
  { name: 'Advanced Reviews', href: '/dashboard/advanced-reviews', icon: StarIcon },
  { name: 'Badges', href: '/dashboard/product-badge', icon: Tag },
  { name: 'Search', href: '/dashboard/advanced-search', icon: Search },
  { name: 'À propos', href: '/dashboard/a-propos', icon: FileTextIcon },
  { name: 'Blog', href: '/dashboard/blog', icon: FileTextIcon },
  { name: 'FAQ', href: '/dashboard/faq', icon: BookOpen },
  ...
  { name: 'Points Store', href: '/dashboard/points-store', icon: StarIcon },
  ...
  { name: 'Vendor Approvals', href: '/dashboard/vendor-approval', icon: CheckCircle },
  { name: 'Warehouse', href: '/dashboard/warehouse', icon: Warehouse },
  { name: 'Product Bundles', href: '/dashboard/product-bundles', icon: Box },
