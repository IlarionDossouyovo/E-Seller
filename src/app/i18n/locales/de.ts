export const translation = {
  ...
  vendor: {
    ...
    inStock: 'auf Lager',
    outOfStock: 'Nicht vorraatig',
    edit: 'Bearbeiten',
    view: 'Ansehen',
    nextPayout: 'Nachste Auszahlung',
    payoutAmount: 'Betrag',
    payoutDate: 'Datum',
    ...
    processingFee: 'Bearbeitungsgebuhr',
    method: 'Methode',
  },

  // Vendor Registration
  vendorRegistration: {
    title: 'Verkaufer werden',
    subtitle: 'Schliessen Sie sich dem E-Seller Marktplatz an',
    ...
    storeUrlRequired: 'Shop-URL ist erforderlich',
    emailRequired: 'E-Mail ist erforderlich',
    phoneRequired: 'Telefon ist erforderlich',
    selectCountry: 'Land auswahlen',
    country: 'Land',
    businessAddress: 'Geschaftsadresse',
    productCategory: 'Produktkategorie',
    selectCategory: 'Kategorie auswahlen',
    storeDescription: 'Shop-Beschreibung',
    describeStore: 'Beschreiben Sie Ihren Shop und Ihre Produkte...',
    taxId: 'Steuer-ID / USt.-Nr.',
    businessLicense: 'Geschaftslizenz',
    uploadLicense: 'Geschaftslizenz oder Registrierung hochladen',
    maxFileSize: 'PDF, JPG, PNG - Max 10MB',
    verificationRequired: 'Verifizierung erforderlich',
    verificationMessage: 'Wir verifizieren Ihr Geschaft innerhalb von 24-48 Stunden.',
    ...
    commission: 'Provision',
    onEachSale: 'bei jedem Verkauf',
    freeToJoin: 'Kostenlos beitreten',
    noUpfrontFees: 'Keine Vorausgebahren. Nur 10% Provision auf Verkauf.',
    globalReach: 'Globale Reichweite',
    sellTo190: 'Verkaufen Sie an Kunden in uber 190 Landern.',
    fastPayouts: 'Schnelle Auszahlungen',
    getPaidWeekly: 'Wochentliche Auszahlung per Bankuberweisung oder PayPal.',
    yourStoreName: 'Ihr Shop-Name',
    yourStore: 'ihr-shop',
    vendorAtStore: 'verkaufer@shop.com',
    phoneNumber: '+1 (555) 000-0000',
    fullAddress: 'Vollstandige Geschaftsadresse',
    taxIdPlaceholder: 'XX-XXXXXXX',
    bankExample: 'Deutsche Bank',
