export const translation = {
  ...
  vendorRegistration: {
    ...
    subtitle: 'Junte-se ao mercado E-Seller',
    storeInfo: 'Informacoes da loja',
    ...
    continue: 'Continuar',
    back: 'Voltar',
    submitApplication: 'Enviar solicitacao',
    storeNameRequired: 'O nome da loja e obrigatorio',
    storeUrlRequired: 'A URL da loja e obrigatoria',
    emailRequired: 'O e-mail e obrigatorio',
    phoneRequired: 'O telefone e obrigatorio',
    selectCountry: 'Selecionar pais',
    country: 'Pais',
    businessAddress: 'Endereco comercial',
    productCategory: 'Categoria de produtos',
    selectCategory: 'Selecionar categoria',
    storeDescription: 'Descricao da loja',
    describeStore: 'Descreva sua loja e produtos...',
    taxId: 'CNPJ / CPF',
    businessLicense: 'Licenca comercial',
    uploadLicense: 'Enviar licenca ou registro',
    maxFileSize: 'PDF, JPG, PNG - Max 10MB',
    verificationRequired: 'Verificacao necessaria',
    verificationMessage: 'Verificaremos seu negocio em 24-48 horas.',
    paymentSettings: 'Configuracoes de pagamento',
    bankName: 'Nome do banco',
    accountNumber: 'Numero da conta',
    routingNumber: 'Numero do banco',
    or: 'OU',
    paypalEmail: 'E-mail PayPal',
    commission: 'Comissao',
    onEachSale: 'em cada venda',
    freeToJoin: 'Gratis para participar',
    noUpfrontFees: 'Sem taxas antecipadas. Apenas 10% de comissao.',
    globalReach: 'Alcance global',
    sellTo190: 'Venda para clientes em mais de 190 paises.',
    fastPayouts: 'Pagamentos rapidos',
    getPaidWeekly: 'Receba semanalmente via transferencia ou PayPal.',
    yourStoreName: 'Nome da sua loja',
    yourStore: 'sua-loja',
    vendorAtStore: 'vendedor@loja.com',
    phoneNumber: '+1 (555) 000-0000',
    fullAddress: 'Endereco comercial completo',
    taxIdPlaceholder: 'XX-XXXXXXX',
    bankExample: 'Banco do Brasil',
    accountPlaceholder: 'XXXX XXXX XXXX',
    routingPlaceholder: 'XXXXXXX',
    paypalExample: 'paypal@vendedor.com',
    applicationSubmitted: 'Solicitacao enviada! Analisaremos em 24-48 horas.',
    selectPayment: 'Metodo de pagamento',
  },
}
